...
@Configuration
@EnableAsync
// Bật lịch chạy định kỳ cho job chốt mùa (features/15, FR-63). Thiếu annotation này thì `@Scheduled`
// bị bỏ qua HOÀN TOÀN mà không có cảnh báo nào — job không chạy, mùa không bao giờ được chốt, và không
