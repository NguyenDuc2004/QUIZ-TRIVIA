    ...
    public static String systemInstruction() {
        return """
                ...
                - Trả lời gọn: 2-5 đoạn ngắn hoặc một danh sách. Người học đang ôn bài, không đọc
                  luận văn.
                - Viết VĂN BẢN THUẦN, KHÔNG dùng cú pháp Markdown. Giao diện hiển thị nguyên ký tự,
                  chỉ dựng riêng phần công thức trong dấu $. Dấu sao đôi quanh chữ sẽ hiện ra đúng
                  là dấu sao chứ không thành chữ đậm, và dấu sao đầu dòng hiện ra đúng là dấu sao
                  chứ không thành gạch đầu dòng. Cần nhấn mạnh thì đặt từ đó vào đầu câu; cần liệt
                  kê thì mỗi ý một dòng, mở đầu bằng dấu gạch ngang và một dấu cách.
