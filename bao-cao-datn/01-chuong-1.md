...
Về sinh đề tự động, cách làm sẵn có là đưa cho mô hình một chủ đề rồi bảo nó viết câu hỏi. Vấn đề nằm ở chỗ giáo viên không kiểm được câu hỏi đó lấy từ đâu: nó có thể hỏi phần chưa dạy tới, hoặc hỏi một chi tiết không có trong giáo trình của lớp. Huấn luyện lại mô hình trên tài liệu riêng cũng không giải quyết được, vì mỗi lần nạp tài liệu mới lại phải huấn luyện lại, và mô hình vẫn không nói được câu hỏi dựa trên đoạn nào. Yêu cầu thực sự ở đây là **truy vết được tới đoạn học liệu nguồn** — cách đề tài đáp ứng yêu cầu này trình bày ở mục 1.3.2.
...
Về gợi ý cá nhân hóa, các nền tảng khảo sát ở mục 1.1.1 gợi ý theo mức phổ biến: bài nhiều người làm thì được đẩy lên trước. Cách đó không trả lời được câu hỏi mà người học đang ôn thi thật sự cần — *tôi yếu chỗ nào và nên làm bài nào tiếp theo*. Muốn trả lời thì phải đi từ một người học qua các bài họ đã làm, tới các chủ đề trong những bài đó, rồi mới vòng sang những bài khác cùng chủ đề. Đây là một phép duyệt nhiều bậc quan hệ, và cách đề tài xử lý trình bày ở mục 1.3.5.
...
Phân quyền theo mô hình RBAC bốn tác nhân, kiểm soát ở tầng phương thức bằng `@PreAuthorize` kết hợp kiểm tra quyền sở hữu tài nguyên thay vì chỉ kiểm tra vai trò. Khi người dùng truy cập tài nguyên của người khác, hệ thống trả về mã 404 thay vì 403 để không tiết lộ sự tồn tại của tài nguyên. Hệ thống được rà theo OWASP Top 10 [12]; hai biện pháp đáng nêu vì chúng xuất phát từ đặc thù của đề tài chứ không phải từ danh mục chung. Thứ nhất, ảnh tải lên được nhận dạng bằng **chữ ký byte** chứ không tin vào `Content-Type` do máy khách khai, và tên tệp do máy chủ sinh từ UUID — hệ thống nhận ảnh từ cả người học lẫn người tạo nội dung, nên đây là bề mặt mở rộng nhất. Thứ hai, nội dung do **AI sinh** cũng được làm sạch như nội dung do người dùng gõ, vì học liệu nguồn có thể chứa sẵn thẻ độc và mô hình chép lại chúng vào câu trả lời. Các biện pháp còn lại theo thông lệ: truy vấn tham số hóa ở cả JPA và Cypher, CORS giới hạn ở nguồn của giao diện, và giới hạn tần suất các endpoint AI.
