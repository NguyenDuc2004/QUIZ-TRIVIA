...
Về mô hình trí tuệ nhân tạo, đề tài không huấn luyện mô hình mới mà tập trung vào kiến trúc tích hợp, khả năng bám nguồn và cơ chế dự phòng giữa các nhà cung cấp. Hệ thống sử dụng Google Gemini làm nhà cung cấp chính và Groq làm nhà cung cấp dự phòng. Ngoài phần lõi, đề tài hiện thực thêm bảy nhóm chức năng ở mức nên có, tuy không thuộc phạm vi bắt buộc: quản trị hệ thống, ôn tập bằng thẻ ghi nhớ kết hợp lặp lại ngắt quãng, chống gian lận khi thi, trò chơi hóa, lớp học và giao bài, bảng xếp hạng theo mùa, thông báo nhắc ôn tập. Sáu yêu cầu lẻ trong các nhóm này cố ý không hiện thực hoặc chỉ hiện thực một phần, đều ở mức nên có hoặc có thể có, và được nêu kèm lý do ở phần Kết luận. Hệ thống được triển khai và đánh giá trên môi trường máy đơn dùng Docker Compose, không hướng tới sản phẩm thương mại.
